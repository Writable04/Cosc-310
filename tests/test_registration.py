...
def test_register_success(registration: Registration, mock_storage: AccountsStorage, mock_auth: Authentication) -> None:
    account = AccountInfo(username="idan", password="Idannnnnnn123", role="admin", email="idan@gmail.com")
    ...
    assert registration.register(account.username, account.password, account.password, account.role, account.email) is account
...
def test_register_account_password_is_not_valid(registration: Registration, mock_storage: AccountsStorage, mock_auth: Authentication) -> None:
    account = AccountInfo(username="idan", password="Idannnn", role="admin", email="idan@gmail.com")
